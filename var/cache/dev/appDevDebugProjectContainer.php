...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('N2BdY6nQ5X', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('reUaq8T219', 0, 'j56gVNs3tYE0m+gi1ZfRtx', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 8001, 'dbname' => 'db_projet', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_3eda40c9e6637ca779e43f632533cd1d031eb651cef2a92952919b5c6cbc0029');
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('PEC4QpsoAb', NULL, 'j56gVNs3tYE0m+gi1ZfRtx', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/SymfoProject/CinemaBundle/Resources/views'), 'SymfoProjectCinema');
        $instance->addPath(($this->targetDirs[3].'/src/SymfoProject/AdminBundle/Resources/views'), 'SymfoProjectAdmin');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('a3db0b682ebeb84bd49788a103143ba1973d7cdb');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+EiLfbZIBQ', 0, 'j56gVNs3tYE0m+gi1ZfRtx', (__DIR__.'/pools'), $this->get('monolog.logger.cache'));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('588fbb0f47b006.19724117')), true);
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'SymfoProjectCinemaBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/SymfoProject/CinemaBundle'),
                    'namespace' => 'SymfoProject\\CinemaBundle',
                ),
                'SymfoProjectAdminBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/SymfoProject/AdminBundle'),
                    'namespace' => 'SymfoProject\\AdminBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SymfoProjectCinemaBundle' => 'SymfoProject\\CinemaBundle\\SymfoProjectCinemaBundle',
                'SymfoProjectAdminBundle' => 'SymfoProject\\AdminBundle\\SymfoProjectAdminBundle',
            ...
            'secret' => 'a3db0b682ebeb84bd49788a103143ba1973d7cdb',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'a3db0b682ebeb84bd49788a103143ba1973d7cdb',
