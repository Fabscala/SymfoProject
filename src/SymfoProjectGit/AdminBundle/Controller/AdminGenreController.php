...
use SymfoProjectGit\CinemaBundle\Entity\Genre;
...
class AdminGenreController extends Controller
{
    ...
    */
    ...
    {
        $genres = $this->getDoctrine()->getRepository('SymfoProjectGitCinemaBundle:Genre')->findAll();
    ...
    */
    public function editAction(Request $request, $id)
    {
        ...
        $genre = $this->getDoctrine()->getRepository('SymfoProjectGitCinemaBundle:Genre')->find($id);
